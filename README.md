...
* **Smart DM Instructions:** If you DM an EchoBox absolutely anything other than the trigger word, it politely replies privately with instructions so you are never left guessing. You can also send the word 'help' to Channel 1 'EchoBox' for these same instructions. This will help if the 'Trigger Word' ever changes.
